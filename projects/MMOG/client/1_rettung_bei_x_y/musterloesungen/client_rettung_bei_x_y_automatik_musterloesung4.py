...
def rettung_bei_x_y(game_client, x_ziel = 0, y_ziel = 0):
    ...
    # damit wir wissen, wann wir feststecken
    hoffnung = 3
    ...
    algorithmus = ("nord_west", "nord", "sued_west")
    ...
    while not ziel_erreicht and hoffnung:
        for richtung in algorithmus: # so lange in eine Richtung laufen, bis wir feststecken
        ...
        hoffnung -= 1
        if re_spawnen > 0 and hoffnung == 0 and not ziel_erreicht:
